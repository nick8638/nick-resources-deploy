...
export default defineConfig({
  ...
  cleanUrls: true,
  sitemap: {
    hostname: 'https://nick8638.github.io'
  },
  vite: {
  ...
  head: [
    ...
    ['meta', { property: 'og:url', content: 'https://nick8638.github.io' }],
    ...
    [
      ...
      JSON.stringify({
        ...
        url: 'https://nick8638.github.io',
        potentialAction: {
          '@type': 'SearchAction',
          target: 'https://nick8638.github.io/?q={search_term_string}',
